...
namespace Axivora.Migrations
{
    ...
    [Migration("20260312175902_AddDepartmentDescriptionAndPatientVitalsRestructure")]
    partial class AddDepartmentDescriptionAndPatientVitalsRestructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Axivora.Models.AppointmentReportView", b =>
                {
                    b.Property<DateTime>("AppointmentEnd")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Axivora.Models.DoctorWorkloadReportView", b =>
                {
                    ...
                    b.ToView("vw_DoctorWorkloadReport", (string)null);
                });
            ...
            modelBuilder.Entity("Axivora.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Axivora.Models.SessionFeedback", b =>
                {
                    ...
                    b.ToTable("SessionFeedbacks", null, t =>
                        {
                            t.HasCheckConstraint("CHK_SessionFeedbacks_Rating", "[Rating] >= 1 AND [Rating] <= 5");
                        });
                });
