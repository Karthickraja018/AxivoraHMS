...
namespace Axivora.Migrations
{
    ...
    [Migration("20260313000000_SeedMedicinesAndLabTests")]
    partial class SeedMedicinesAndLabTests
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Axivora.Models.DoctorWorkloadReportView", b =>
                {
                    ...
                    b.ToView("vw_DoctorWorkloadReport");
                });
            ...
            modelBuilder.Entity("Axivora.Models.SessionFeedback", b =>
                {
                    ...
                    b.HasCheckConstraint("CHK_SessionFeedbacks_Rating", "[Rating] >= 1 AND [Rating] <= 5");
                });
